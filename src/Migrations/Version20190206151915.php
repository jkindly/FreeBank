 ...
 */
final class Version20190206151915 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bank_account CHANGE account_number account_number VARCHAR(32) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bank_account CHANGE account_number account_number VARCHAR(26) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
