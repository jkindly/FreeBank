 ...
 */
final class Version20190206215429 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bank_account ADD user_id INT NOT NULL, CHANGE account_number account_number VARCHAR(32) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bank_account DROP user_id, CHANGE account_number account_number VARCHAR(26) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
